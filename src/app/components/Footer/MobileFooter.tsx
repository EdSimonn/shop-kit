    ...
    <div className="md:hidden">
      ...
      <div className="flex flex-col px-5 py-5">
        ...
        <div className="flex gap-4 mt-4">
          ...
          />
          <button className="py-2 px-6 bg-white text-sm font-bold transition duration-500 hover:bg-black hover:text-white">
            SUBMIT
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:gap-5 items-center justify-center px-5 py-5">
